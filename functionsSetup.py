...
def generateSetup(L, K, N, tau_p, ASD_varphi, ASD_theta, nbrOfRealizations, seed = 0, mode='test'):
...
def Test_generateSetup(L, K, N, tau_p, ASD_varphi, ASD_theta, nbrOfRealizations, seed = 0, mode='test'):
    """Generates realizations of the setup
    INPUT>
